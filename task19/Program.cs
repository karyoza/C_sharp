...
int[] Reveret(int[] arr)   // метод , создаем новый масив newarr 
{
int[] newArr = new int[arr.Length];    //  в newarr передаем длину массива arr
for (int i = 0; i < newArr.Length; i++)
{
newArr[i] = -arr[i]; //  заполняем новый массив
}
